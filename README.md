...
## Setup
* Extract RadASM2 to wherever you want.
...
## Notes
For a seamless work via **MASM64 with RadASM2**, you must be sure that you've installed **MASM64 SDK** properly. Creators of MASM64 SDK cannot distribute Microsoft binaries; me neither. So you have to install a Windows SDK to your machine and copy some binaries under `c:\masm64\bin64` and `c:\masm64\bin64\1033`
